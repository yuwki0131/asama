...
- **大方針: ビジュアル品質向上 — 高低差ビジュアル一式完了、ユニットアニメ2D化の最終化へ**
- 完了してmainに統合済み: #23〜#51
...
| PR/Branch | 内容 | 状態 |
|---|---|---|
| feat/unit-anim-paintover | ユニットアニメ22シートのcodexペイントオーバー2D化 | 12/22完了・codex上限リセット(9:41)後に残り10シート自動処理→PR |
...
1. ユニットアニメ残り10シート (codex 9:41リセット後自動) → PR → merge
2. 高低差の実プレイ視覚確認 (ユーザー判定待ち: 石垣隙間・坂接続・木の前後関係、h4/h5 の見え方)
3. 違和感あれば h4/h5 を台形断面(下広がり)に再調整
4. 既知の残課題: 崖フェイススプライトが幾何フェイスより短く下部がバックドロップ単色帯になる件 (#51で指摘、アセット側の調整)
