...
export const concentricCastleScenario: ContentScenarioDefinition = {
  ...
  initialBuildings: [
    ...
    // 北壁
    { type: "wall", position: { x: 56, y: 28 } },
    { type: "wall", position: { x: 57, y: 28 } },
    { type: "wall", position: { x: 58, y: 28 } },
    { type: "wall", position: { x: 59, y: 28 } },
    { type: "wall", position: { x: 60, y: 28 } },
    { type: "wall", position: { x: 61, y: 28 } },
    { type: "wall", position: { x: 62, y: 28 } },
    { type: "wall", position: { x: 63, y: 28 } },
    { type: "wall", position: { x: 64, y: 28 } },
    { type: "wall", position: { x: 65, y: 28 } },
    { type: "wall", position: { x: 66, y: 28 } },
    { type: "wall", position: { x: 67, y: 28 } },
    { type: "wall", position: { x: 68, y: 28 } },
    { type: "wall", position: { x: 69, y: 28 } },
    { type: "wall", position: { x: 70, y: 28 } },
    // 西壁
    { type: "wall", position: { x: 56, y: 29 } },
    { type: "wall", position: { x: 56, y: 30 } },
    { type: "wall", position: { x: 56, y: 31 } },
    { type: "wall", position: { x: 56, y: 32 } },
    { type: "wall", position: { x: 56, y: 33 } },
    { type: "wall", position: { x: 56, y: 34 } },
    { type: "wall", position: { x: 56, y: 35 } },
    { type: "wall", position: { x: 56, y: 36 } },
    { type: "wall", position: { x: 56, y: 37 } },
    { type: "wall", position: { x: 56, y: 38 } },
    { type: "wall", position: { x: 56, y: 39 } },
    { type: "wall", position: { x: 56, y: 40 } },
    { type: "wall", position: { x: 56, y: 41 } },
    { type: "wall", position: { x: 56, y: 42 } },
    // 東壁
    { type: "wall", position: { x: 70, y: 29 } },
    { type: "wall", position: { x: 70, y: 30 } },
    { type: "wall", position: { x: 70, y: 31 } },
    { type: "wall", position: { x: 70, y: 32 } },
    { type: "wall", position: { x: 70, y: 33 } },
    { type: "wall", position: { x: 70, y: 34 } },
    { type: "wall", position: { x: 70, y: 35 } },
    { type: "wall", position: { x: 70, y: 36 } },
    { type: "wall", position: { x: 70, y: 37 } },
    { type: "wall", position: { x: 70, y: 38 } },
    { type: "wall", position: { x: 70, y: 39 } },
    { type: "wall", position: { x: 70, y: 40 } },
    { type: "wall", position: { x: 70, y: 41 } },
    { type: "wall", position: { x: 70, y: 42 } },
    // 南壁 — gate_wide_3 at x=62 (x=62,63,64 を占有)
    { type: "wall", position: { x: 56, y: 43 } },
    { type: "wall", position: { x: 57, y: 43 } },
    { type: "wall", position: { x: 58, y: 43 } },
    { type: "wall", position: { x: 59, y: 43 } },
    { type: "wall", position: { x: 60, y: 43 } },
    { type: "wall", position: { x: 61, y: 43 } },
    { type: "gate_wide_3", position: { x: 62, y: 43 } },
    { type: "wall", position: { x: 65, y: 43 } },
    { type: "wall", position: { x: 66, y: 43 } },
    { type: "wall", position: { x: 67, y: 43 } },
    { type: "wall", position: { x: 68, y: 43 } },
    { type: "wall", position: { x: 69, y: 43 } },
    { type: "wall", position: { x: 70, y: 43 } },
    // 天守(8×8) + 本丸マーカー
    { type: "tenshu", position: { x: 57, y: 29 } },
    { type: "honmaru", position: { x: 67, y: 40 } },

    // === 水堀リング x=54-72, y=26-45 ===
    // 北堀
    { type: "water_moat", position: { x: 54, y: 26 } },
    { type: "water_moat", position: { x: 55, y: 26 } },
    { type: "water_moat", position: { x: 56, y: 26 } },
    { type: "water_moat", position: { x: 57, y: 26 } },
    { type: "water_moat", position: { x: 58, y: 26 } },
    { type: "water_moat", position: { x: 59, y: 26 } },
    { type: "water_moat", position: { x: 60, y: 26 } },
    { type: "water_moat", position: { x: 61, y: 26 } },
    { type: "water_moat", position: { x: 62, y: 26 } },
    { type: "water_moat", position: { x: 63, y: 26 } },
    { type: "water_moat", position: { x: 64, y: 26 } },
    { type: "water_moat", position: { x: 65, y: 26 } },
    { type: "water_moat", position: { x: 66, y: 26 } },
    { type: "water_moat", position: { x: 67, y: 26 } },
    { type: "water_moat", position: { x: 68, y: 26 } },
    { type: "water_moat", position: { x: 69, y: 26 } },
    { type: "water_moat", position: { x: 70, y: 26 } },
    { type: "water_moat", position: { x: 71, y: 26 } },
    { type: "water_moat", position: { x: 72, y: 26 } },
    // 西堀
    { type: "water_moat", position: { x: 54, y: 27 } },
    { type: "water_moat", position: { x: 54, y: 28 } },
    { type: "water_moat", position: { x: 54, y: 29 } },
    { type: "water_moat", position: { x: 54, y: 30 } },
    { type: "water_moat", position: { x: 54, y: 31 } },
    { type: "water_moat", position: { x: 54, y: 32 } },
    { type: "water_moat", position: { x: 54, y: 33 } },
    { type: "water_moat", position: { x: 54, y: 34 } },
    { type: "water_moat", position: { x: 54, y: 35 } },
    { type: "water_moat", position: { x: 54, y: 36 } },
    { type: "water_moat", position: { x: 54, y: 37 } },
    { type: "water_moat", position: { x: 54, y: 38 } },
    { type: "water_moat", position: { x: 54, y: 39 } },
    { type: "water_moat", position: { x: 54, y: 40 } },
    { type: "water_moat", position: { x: 54, y: 41 } },
    { type: "water_moat", position: { x: 54, y: 42 } },
    { type: "water_moat", position: { x: 54, y: 43 } },
    { type: "water_moat", position: { x: 54, y: 44 } },
    // 東堀
    { type: "water_moat", position: { x: 72, y: 27 } },
    { type: "water_moat", position: { x: 72, y: 28 } },
    { type: "water_moat", position: { x: 72, y: 29 } },
    { type: "water_moat", position: { x: 72, y: 30 } },
    { type: "water_moat", position: { x: 72, y: 31 } },
    { type: "water_moat", position: { x: 72, y: 32 } },
    { type: "water_moat", position: { x: 72, y: 33 } },
    { type: "water_moat", position: { x: 72, y: 34 } },
    { type: "water_moat", position: { x: 72, y: 35 } },
    { type: "water_moat", position: { x: 72, y: 36 } },
    { type: "water_moat", position: { x: 72, y: 37 } },
    { type: "water_moat", position: { x: 72, y: 38 } },
    { type: "water_moat", position: { x: 72, y: 39 } },
    { type: "water_moat", position: { x: 72, y: 40 } },
    { type: "water_moat", position: { x: 72, y: 41 } },
    { type: "water_moat", position: { x: 72, y: 42 } },
    { type: "water_moat", position: { x: 72, y: 43 } },
    { type: "water_moat", position: { x: 72, y: 44 } },
    // 南堀 — earth_bridge at x=63 (土橋は大手道と一直線)
    { type: "water_moat", position: { x: 54, y: 45 } },
    { type: "water_moat", position: { x: 55, y: 45 } },
    { type: "water_moat", position: { x: 56, y: 45 } },
    { type: "water_moat", position: { x: 57, y: 45 } },
    { type: "water_moat", position: { x: 58, y: 45 } },
    { type: "water_moat", position: { x: 59, y: 45 } },
    { type: "water_moat", position: { x: 60, y: 45 } },
    { type: "water_moat", position: { x: 61, y: 45 } },
    { type: "water_moat", position: { x: 62, y: 45 } },
    { type: "earth_bridge", position: { x: 63, y: 45 } },
    { type: "water_moat", position: { x: 64, y: 45 } },
    { type: "water_moat", position: { x: 65, y: 45 } },
    { type: "water_moat", position: { x: 66, y: 45 } },
    { type: "water_moat", position: { x: 67, y: 45 } },
    { type: "water_moat", position: { x: 68, y: 45 } },
    { type: "water_moat", position: { x: 69, y: 45 } },
    { type: "water_moat", position: { x: 70, y: 45 } },
    { type: "water_moat", position: { x: 71, y: 45 } },
    { type: "water_moat", position: { x: 72, y: 45 } },

    // === 二之丸(外郭) — 柵リング x=48-78, y=20-57 ===
    // 北柵
    { type: "fence", position: { x: 48, y: 20 } },
    { type: "fence", position: { x: 49, y: 20 } },
    { type: "fence", position: { x: 50, y: 20 } },
    { type: "fence", position: { x: 51, y: 20 } },
    { type: "fence", position: { x: 52, y: 20 } },
    { type: "fence", position: { x: 53, y: 20 } },
    { type: "fence", position: { x: 54, y: 20 } },
    { type: "fence", position: { x: 55, y: 20 } },
    { type: "fence", position: { x: 56, y: 20 } },
    { type: "fence", position: { x: 57, y: 20 } },
    { type: "fence", position: { x: 58, y: 20 } },
    { type: "fence", position: { x: 59, y: 20 } },
    { type: "fence", position: { x: 60, y: 20 } },
    { type: "fence", position: { x: 61, y: 20 } },
    { type: "fence", position: { x: 62, y: 20 } },
    { type: "fence", position: { x: 63, y: 20 } },
    { type: "fence", position: { x: 64, y: 20 } },
    { type: "fence", position: { x: 65, y: 20 } },
    { type: "fence", position: { x: 66, y: 20 } },
    { type: "fence", position: { x: 67, y: 20 } },
    { type: "fence", position: { x: 68, y: 20 } },
    { type: "fence", position: { x: 69, y: 20 } },
    { type: "fence", position: { x: 70, y: 20 } },
    { type: "fence", position: { x: 71, y: 20 } },
    { type: "fence", position: { x: 72, y: 20 } },
    { type: "fence", position: { x: 73, y: 20 } },
    { type: "fence", position: { x: 74, y: 20 } },
    { type: "fence", position: { x: 75, y: 20 } },
    { type: "fence", position: { x: 76, y: 20 } },
    { type: "fence", position: { x: 77, y: 20 } },
    { type: "fence", position: { x: 78, y: 20 } },
    // 西柵
    { type: "fence", position: { x: 48, y: 21 } },
    { type: "fence", position: { x: 48, y: 22 } },
    { type: "fence", position: { x: 48, y: 23 } },
    { type: "fence", position: { x: 48, y: 24 } },
    { type: "fence", position: { x: 48, y: 25 } },
    { type: "fence", position: { x: 48, y: 26 } },
    { type: "fence", position: { x: 48, y: 27 } },
    { type: "fence", position: { x: 48, y: 28 } },
    { type: "fence", position: { x: 48, y: 29 } },
    { type: "fence", position: { x: 48, y: 30 } },
    { type: "fence", position: { x: 48, y: 31 } },
    { type: "fence", position: { x: 48, y: 32 } },
    { type: "fence", position: { x: 48, y: 33 } },
    { type: "fence", position: { x: 48, y: 34 } },
    { type: "fence", position: { x: 48, y: 35 } },
    { type: "fence", position: { x: 48, y: 36 } },
    { type: "fence", position: { x: 48, y: 37 } },
    { type: "fence", position: { x: 48, y: 38 } },
    { type: "fence", position: { x: 48, y: 39 } },
    { type: "fence", position: { x: 48, y: 40 } },
    { type: "fence", position: { x: 48, y: 41 } },
    { type: "fence", position: { x: 48, y: 42 } },
    { type: "fence", position: { x: 48, y: 43 } },
    { type: "fence", position: { x: 48, y: 44 } },
    { type: "fence", position: { x: 48, y: 45 } },
    { type: "fence", position: { x: 48, y: 46 } },
    { type: "fence", position: { x: 48, y: 47 } },
    { type: "fence", position: { x: 48, y: 48 } },
    { type: "fence", position: { x: 48, y: 49 } },
    { type: "fence", position: { x: 48, y: 50 } },
    { type: "fence", position: { x: 48, y: 51 } },
    { type: "fence", position: { x: 48, y: 52 } },
    { type: "fence", position: { x: 48, y: 53 } },
    { type: "fence", position: { x: 48, y: 54 } },
    { type: "fence", position: { x: 48, y: 55 } },
    { type: "fence", position: { x: 48, y: 56 } },
    // 東柵
    { type: "fence", position: { x: 78, y: 21 } },
    { type: "fence", position: { x: 78, y: 22 } },
    { type: "fence", position: { x: 78, y: 23 } },
    { type: "fence", position: { x: 78, y: 24 } },
    { type: "fence", position: { x: 78, y: 25 } },
    { type: "fence", position: { x: 78, y: 26 } },
    { type: "fence", position: { x: 78, y: 27 } },
    { type: "fence", position: { x: 78, y: 28 } },
    { type: "fence", position: { x: 78, y: 29 } },
    { type: "fence", position: { x: 78, y: 30 } },
    { type: "fence", position: { x: 78, y: 31 } },
    { type: "fence", position: { x: 78, y: 32 } },
    { type: "fence", position: { x: 78, y: 33 } },
    { type: "fence", position: { x: 78, y: 34 } },
    { type: "fence", position: { x: 78, y: 35 } },
    { type: "fence", position: { x: 78, y: 36 } },
    { type: "fence", position: { x: 78, y: 37 } },
    { type: "fence", position: { x: 78, y: 38 } },
    { type: "fence", position: { x: 78, y: 39 } },
    { type: "fence", position: { x: 78, y: 40 } },
    { type: "fence", position: { x: 78, y: 41 } },
    { type: "fence", position: { x: 78, y: 42 } },
    { type: "fence", position: { x: 78, y: 43 } },
    { type: "fence", position: { x: 78, y: 44 } },
    { type: "fence", position: { x: 78, y: 45 } },
    { type: "fence", position: { x: 78, y: 46 } },
    { type: "fence", position: { x: 78, y: 47 } },
    { type: "fence", position: { x: 78, y: 48 } },
    { type: "fence", position: { x: 78, y: 49 } },
    { type: "fence", position: { x: 78, y: 50 } },
    { type: "fence", position: { x: 78, y: 51 } },
    { type: "fence", position: { x: 78, y: 52 } },
    { type: "fence", position: { x: 78, y: 53 } },
    { type: "fence", position: { x: 78, y: 54 } },
    { type: "fence", position: { x: 78, y: 55 } },
    { type: "fence", position: { x: 78, y: 56 } },
    // 南柵 — gate_wide_3 at x=62 (大手道南門)
    { type: "fence", position: { x: 48, y: 57 } },
    { type: "fence", position: { x: 49, y: 57 } },
    { type: "fence", position: { x: 50, y: 57 } },
    { type: "fence", position: { x: 51, y: 57 } },
    { type: "fence", position: { x: 52, y: 57 } },
    { type: "fence", position: { x: 53, y: 57 } },
    { type: "fence", position: { x: 54, y: 57 } },
    { type: "fence", position: { x: 55, y: 57 } },
    { type: "fence", position: { x: 56, y: 57 } },
    { type: "fence", position: { x: 57, y: 57 } },
    { type: "fence", position: { x: 58, y: 57 } },
    { type: "fence", position: { x: 59, y: 57 } },
    { type: "fence", position: { x: 60, y: 57 } },
    { type: "fence", position: { x: 61, y: 57 } },
    { type: "gate_wide_3", position: { x: 62, y: 57 } },
    { type: "fence", position: { x: 65, y: 57 } },
    { type: "fence", position: { x: 66, y: 57 } },
    { type: "fence", position: { x: 67, y: 57 } },
    { type: "fence", position: { x: 68, y: 57 } },
    { type: "fence", position: { x: 69, y: 57 } },
    { type: "fence", position: { x: 70, y: 57 } },
    { type: "fence", position: { x: 71, y: 57 } },
    { type: "fence", position: { x: 72, y: 57 } },
    { type: "fence", position: { x: 73, y: 57 } },
    { type: "fence", position: { x: 74, y: 57 } },
    { type: "fence", position: { x: 75, y: 57 } },
    { type: "fence", position: { x: 76, y: 57 } },
    { type: "fence", position: { x: 77, y: 57 } },
    { type: "fence", position: { x: 78, y: 57 } },

    // === 二之丸内部 — 隅櫓2基・蔵2棟・兵舎・市場・侍屋敷 ===
    // 隅櫓: 北西・北東
    { type: "yagura", position: { x: 49, y: 21 } },
    { type: "yagura", position: { x: 76, y: 21 } },
    // 蔵 2棟 (西寄り)
    { type: "storehouse", position: { x: 49, y: 30 } },
    { type: "storehouse", position: { x: 49, y: 35 } },
    // 兵舎 (東寄り)
    { type: "barracks", position: { x: 73, y: 30 } },
    // 市場 (南東区画)
    { type: "market", position: { x: 68, y: 50 } },
    // 侍屋敷 (南西区画)
    { type: "samurai_residence", position: { x: 49, y: 48 } },

    // === 城下町 — 南の大手道(x=63)沿い ===
    // 大手道
    { type: "road", position: { x: 63, y: 58 } },
    { type: "road", position: { x: 63, y: 59 } },
    { type: "road", position: { x: 63, y: 60 } },
    { type: "road", position: { x: 63, y: 61 } },
    { type: "road", position: { x: 63, y: 62 } },
    { type: "road", position: { x: 63, y: 63 } },
    { type: "road", position: { x: 63, y: 64 } },
    { type: "road", position: { x: 63, y: 65 } },
    { type: "road", position: { x: 63, y: 66 } },
    { type: "road", position: { x: 63, y: 67 } },
    { type: "road", position: { x: 63, y: 68 } },
    { type: "road", position: { x: 63, y: 69 } },
    { type: "road", position: { x: 63, y: 70 } },
    { type: "road", position: { x: 63, y: 71 } },
    { type: "road", position: { x: 63, y: 72 } },
    { type: "road", position: { x: 63, y: 73 } },
    { type: "road", position: { x: 63, y: 74 } },
    { type: "road", position: { x: 63, y: 75 } },
    { type: "road", position: { x: 63, y: 76 } },
    { type: "road", position: { x: 63, y: 77 } },
    { type: "road", position: { x: 63, y: 78 } },
    // 町区画 (道路の東西)
    { type: "town_block", position: { x: 54, y: 60 } },
    { type: "town_block", position: { x: 65, y: 60 } },
    // 農地
    { type: "farm", position: { x: 51, y: 76 } },
    { type: "farm", position: { x: 65, y: 76 } },
  ],
  initialUnits: [
    // 本丸ガリソン (天守東側の空間)
    { type: "spear_ashigaru", position: { x: 65, y: 40 }, owner: "player" },
    { type: "sword_ashigaru", position: { x: 66, y: 38 }, owner: "player" },
    { type: "archer", position: { x: 65, y: 37 }, owner: "player" },
    // 二之丸南門付近 (大手道守備)
    { type: "archer", position: { x: 63, y: 52 }, owner: "player" },
