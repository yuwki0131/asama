...
export const castleTownGateScenario: ContentScenarioDefinition = {
  ...
  initialUnits: [
    ...
    { type: "spear_ashigaru", position: { x: 51, y: 63 }, owner: "player" },
    { type: "archer", position: { x: 48, y: 62 }, owner: "player" },
    // 惣構大手門の門番と大手筋の射撃線。
    ...
    { type: "spear_ashigaru", position: { x: 49, y: 98 }, owner: "player" },
    { type: "spear_ashigaru", position: { x: 51, y: 98 }, owner: "player" },
    { type: "archer", position: { x: 50, y: 96 }, owner: "player" },
    { type: "sword_ashigaru", position: { x: 51, y: 93 }, owner: "player" },

    // 敵の物見 (街道)。
    { type: "spear_ashigaru", position: { x: 48, y: 104 }, owner: "enemy" },
    { type: "archer", position: { x: 52, y: 105 }, owner: "enemy" },
    { type: "spear_ashigaru", position: { x: 50, y: 104 }, owner: "enemy" },
    { type: "archer", position: { x: 46, y: 105 }, owner: "enemy" },
  ],
  waves: [
    {
      // 第1波: 大手門への前哨。
      ...
      spawns: [
        ...
        { type: "spear_ashigaru", position: { x: 46, y: 106 } },
    ...
    },
    {
      ...
      spawns: [
        ...
        { type: "sword_ashigaru", position: { x: 51, y: 106 } },
        { type: "archer", position: { x: 50, y: 108 } },
    ...
    },
    {
      ...
      spawns: [
        ...
        { type: "sword_ashigaru", position: { x: 46, y: 106 } },
        { type: "spear_ashigaru", position: { x: 54, y: 106 } },
        { type: "archer", position: { x: 51, y: 108 } },
    ...
    },
    {
      ...
      spawns: [
        ...
        { type: "spear_ashigaru", position: { x: 45, y: 106 } },
        { type: "sword_ashigaru", position: { x: 55, y: 106 } },
        { type: "archer", position: { x: 46, y: 108 } },
        { type: "cavalry", position: { x: 33, y: 104 } },
        { type: "cavalry", position: { x: 67, y: 104 } },
        { type: "cavalry", position: { x: 31, y: 104 } },
