...
MODEL_REGISTRY = {
    ...
    # Tanzaku machiya: 3 variants x 2 orientations (2x1 nw_se / 1x2 ne_sw).
    "building-machiya-v1-nw_se": lambda scene: build_machiya(scene, variant=1, orientation="nw_se"),
    "building-machiya-v2-nw_se": lambda scene: build_machiya(scene, variant=2, orientation="nw_se"),
    "building-machiya-v3-nw_se": lambda scene: build_machiya(scene, variant=3, orientation="nw_se"),
    "building-machiya-v1-ne_sw": lambda scene: build_machiya(scene, variant=1, orientation="ne_sw"),
    "building-machiya-v2-ne_sw": lambda scene: build_machiya(scene, variant=2, orientation="ne_sw"),
    "building-machiya-v3-ne_sw": lambda scene: build_machiya(scene, variant=3, orientation="ne_sw"),
    "building-yagura-small-graybox": build_yagura_small_graybox,
    "building-garden-v0": lambda scene: build_garden(scene, variant=0),
    "building-garden-v1": lambda scene: build_garden(scene, variant=1),
    "building-garden-v2": lambda scene: build_garden(scene, variant=2),
    "building-garden-v3": lambda scene: build_garden(scene, variant=3),
    ...
    "wall-diagonal-arm-nw": lambda scene: build_wall_diagonal_arm(scene, "nw"),
    "wall-diagonal-arm-ne": lambda scene: build_wall_diagonal_arm(scene, "ne"),
