// Visual QA: screenshot the tenshu in 五段積の城 (worktree dev server :5185).
// Usage: node qa-tenshu-shot.mjs <outPath> [dx,dy offset from tenshu]
...
await page.goto("http://127.0.0.1:5185/", { waitUntil: "load" });
