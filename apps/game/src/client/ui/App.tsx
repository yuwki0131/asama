...
const CASTLE_TOOLS: readonly { readonly type: BuildingType; readonly label: string }[] = [
  ...
  { type: "arc_wall_r3_ne", label: "弧小NE" },
  { type: "arc_wall_r3_se", label: "弧小SE" },
  { type: "arc_wall_r3_sw", label: "弧小SW" },
  { type: "arc_wall_r3_nw", label: "弧小NW" },
  { type: "arc_wall_r4_ne", label: "弧大NE" },
  { type: "arc_wall_r4_se", label: "弧大SE" },
  { type: "arc_wall_r4_sw", label: "弧大SW" },
  { type: "arc_wall_r4_nw", label: "弧大NW" },
...
const ECONOMY_TOOLS: readonly { readonly type: BuildingType; readonly label: string }[] = [
  ...
  { type: "machiya", label: "町屋横" },
  { type: "machiya_ne_sw", label: "町屋縦" },
