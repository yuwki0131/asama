...
export function buildingTypeLabel(type: BuildingType): string {
  const labels: Record<BuildingType, string> = {
    ...
    arc_wall_r3_ne: "円弧塀(小NE)",
    arc_wall_r3_se: "円弧塀(小SE)",
    arc_wall_r3_sw: "円弧塀(小SW)",
    arc_wall_r3_nw: "円弧塀(小NW)",
    arc_wall_r4_ne: "円弧塀(大NE)",
    arc_wall_r4_se: "円弧塀(大SE)",
    arc_wall_r4_sw: "円弧塀(大SW)",
    arc_wall_r4_nw: "円弧塀(大NW)",
    fence: "木塀",
    diagonal_fence_nwse: "斜め木塀(縦)",
    diagonal_fence_nesw: "斜め木塀(横)",
    gate_wide_2: "門(広2)",
    ...
    diagonal_dry_moat_nesw: "斜め空堀(横)",
    diagonal_water_moat_nwse: "斜め水堀(縦)",
    diagonal_water_moat_nesw: "斜め水堀(横)",
    river: "川",
    diagonal_river_nwse: "斜め川(縦)",
    diagonal_river_nesw: "斜め川(横)",
    storehouse: "蔵",
    market: "市場",
    barracks: "兵舎",
